...
def entry(request, subpath: str = ""):
    stand = get_object_or_404(Stand, slug="sofc_streamlit", is_active=True)
    ...
    return proxy_to_upstream(request, stand.upstream_url, subpath=subpath, mount_prefix="/projects/sofc_streamlit/")
