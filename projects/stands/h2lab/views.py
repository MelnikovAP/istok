...
def entry(request, subpath: str = ""):
    stand = get_object_or_404(Stand, slug="h2lab", is_active=True)
    ...
    return proxy_to_upstream(request, stand.upstream_url, subpath=subpath, mount_prefix="/projects/h2lab/")
